  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved inquiry as @inquiry" do
        ...
        post :create, {:inquiry => { "email" => "invalid value" }}, valid_session
        assigns(:inquiry).should be_a_new(Inquiry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested inquiry" do
        ...
        Inquiry.any_instance.should_receive(:update).with({ "email" => "MyString" })
        put :update, {:id => inquiry.to_param, :inquiry => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the inquiry as @inquiry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Inquiry.any_instance.stub(:save).and_return(false)
        put :update, {:id => inquiry.to_param, :inquiry => { "email" => "invalid value" }}, valid_session
        assigns(:inquiry).should eq(inquiry)
      end
